...
<body>
  ...
  <section>
    <a href="nueva_slide.php">Nuevo Slide</a>
    <table>
      <thead>
        <tr>
          <th>Slides</th>
      ...
      <tbody>
        <?php 
          try {
            //Montamos la consulta para mostrar los slides que tenemos 
            $sql="Select nombre, id from slides";
            $stmt=$con->prepare($sql);
            if  ($stmt->execute()){
              while ($fila=$stmt->fetch()){
        ?>
                <tr>
                  <td><?=$fila['nombre']?></td>
                  <td>
                    <a href="modificar_slide.php?idslide=<?=$fila['id']?>" class="button">Modificar</a>
                    <a href="eliminar_slide.php?idslide=<?=$fila['id']?>" class="button button-red">Eliminar</a>
                  </td>
                </tr>
        <?php
              }
