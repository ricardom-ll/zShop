...
<body>
  ...
  <section>
    <a href="nueva_cat.php">Nueva Categoria</a>
    <table>
      <thead>
        <tr>
          <th>Categorias</th>
      ...
      <tbody>
        ...
        ?>
                <tr>
                  <td><?=$fila['nombre']?></td>
                  <td>
                    <a href="modificar_cat.php?idcat=<?=$fila['id']?>" class="button">Modificar</a>
                    <a href="eliminar_cat.php?idcat=<?=$fila['id']?>" class="button button-red">Eliminar</a>
                  </td>
                </tr>
        <?php
              }
