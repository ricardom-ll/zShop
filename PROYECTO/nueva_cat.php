        ...
        if (is_uploaded_file($_FILES['imagen']['tmp_name'])){
            ...
            if ($_FILES['imagen']['type']=="image/jpeg" || $_FILES['imagen']['type']=="image/jpg"){
                if(!isset($errores)){
                  ...
                  try {
                      $sql="INSERT INTO `categorias` (`nombre`, `imagen`) VALUES ('$nombre', '$nombreDefinitivo')";
...
<body>
  ...
  <section>
    <form method="post" enctype="multipart/form-data">
        Nombre de categoría: <input type="text" name="nombre" value="<?=isset($nombre) && isset($errores) ? $nombre : ''?>" /><br/>
